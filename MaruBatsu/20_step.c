...
// テキストを見ながら、勝者を表示するための画像と引き分けを表示するための画像を保持する変数を追加しよう。
...
void stage_kaku(void)
{
    ...
    // テキストを見ながら、勝者が居たら勝者の表示をして引き分けなら引き分けの表示をするコードを書いてみよう。
...
int main(int argc, char **argv)
{
    ...
    // テキストを見ながら、勝利・引き分け用の画像を読み込みむコードを書いてみよう。
    ...
    // テキストを見ながら、読み込んだ勝利・引き分け用の画像を片付けるコードを書いてみよう。
